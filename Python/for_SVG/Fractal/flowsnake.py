...
#svg+= make_polyline(flowsnake(v1,v2,2),color='green', width=1.5)
#svg+= make_polyline(flowsnake(v1,v2,3),color='black', width=2)
#svg+= make_polyline(flowsnake(v1,v2,4),color='cyan', width=2.5)
svg+= make_polyline(flowsnake(v1,v2,3),color='black', width=1.5)

svg += '</svg>'

f = open("flowsnake_test.svg", "w", encoding="UTF-8")
f.write(svg)
f.close()
